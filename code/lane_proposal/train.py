...
from utils.postprocess import embedding_post_process, LaneNetCluster
...
val_loader = DataLoader(val_dataset, batch_size=8, collate_fn=val_dataset.collate, num_workers=8)
