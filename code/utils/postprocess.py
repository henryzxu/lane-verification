...
class LaneNetCluster(object):
    ...
    def _cluster(prediction, bandwidth):
        ...
        ms = MeanShift(bandwidth=bandwidth, bin_seeding=True, min_bin_freq=100, cluster_all=False)
    ...
    def get_lane_mask(self, binary_seg_ret, instance_seg_ret, gt_image, gen_mask=False):
        """
...
def embedding_post_process(embedding, bin_seg, band_width=1.5, max_num_lane=4):
    ...
    mean_shift = MeanShift(bandwidth=1.5, bin_seeding=True, n_jobs=-1, min_bin_freq=100, cluster_all=False)
